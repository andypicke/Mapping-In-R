...
For the choropleth map I will use state population as the variable to show. I'll get state population data from the @tidycensus package. If you haven't used this package before you will need to obtain a free API key. I have stored my API key in my .Renviron file.
